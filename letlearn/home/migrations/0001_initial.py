    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagelink', models.ImageField(null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schoolimage', models.ImageField(null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schoolid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='student.school')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.tblclass')),
                ('courseid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.course')),
                ('dayid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.day')),
                ('schoolid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.school')),
                ('sectionid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.section')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignmentid', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='student.schoolassignment')),
                ('courseid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='student.course')),
                ('schoolid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='student.school')),
                ('studentid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='student.student')),
            ],
        ),
        migrations.CreateModel(
            name='StudentResult',
            fields=[
                ...
                ('classid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.tblclass')),
                ('courseid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.course')),
                ('examid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.exam')),
                ('schoolid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.school')),
                ('sectionid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.section')),
        ...
        migrations.AddField(
            model_name='student',
            name='classid',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='student.tblclass'),
        ),
        migrations.AddField(
            model_name='student',
            name='schoolid',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='student.school'),
        ),
        migrations.AddField(
            model_name='student',
            name='sectionid',
        ...
        migrations.AddField(
            model_name='schoolassignment',
            name='userid',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.client'),
        ),
        migrations.AddField(
            model_name='course',
            name='classid',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.tblclass'),
        ),
        migrations.AddField(
            model_name='course',
            name='roleid',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.rolename'),
        ),
        migrations.AddField(
            model_name='course',
            name='userid',
        ...
        migrations.AddField(
            model_name='client',
            name='status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.status'),
        ),
    ]
